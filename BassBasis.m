        ...
        function obj = BassBasis(xx, y, basis, newy, y_mean, y_sd, trunc_error, ncores, opts, fit)
            ...
            if fit
                if ncores == 1
                    ...
                    for ii = 1:obj.nbasis
                        obj.bm_list{ii} = bass(obj.xx, obj.newy(ii,:)', 'nmcmc', opts.nmcmc, 'nburn', opts.nburn, 'thin', opts.thin, ...
                            'w1', opts.w1, 'w2', opts.w2, 'maxInt', opts.maxInt, 'maxBasis', opts.maxBasis, 'npart', opts.npart, 'g1', opts.g1, ...
                            'g2', opts.g2, 's2_lower', opts.s2_lower, 'h1', opts.h1, 'h2', opts.h2, 'a_tau', opts.a_tau, 'b_tau', opts.b_tau, 'verbose', opts.verbose);
                    end
                else
